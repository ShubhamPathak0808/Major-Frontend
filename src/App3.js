...
import AnalogSimulator from "./components/AnalogSimulator";
    ...
    <div>
      <BrowserRouter>
        ...
        <Switch>
          ...
          <Route path="/AnalogSimulator" render={() => <><AnalogSimulator /></>} exact />
          ...
          <Route path="/AnalogSimulator/*" render={() => <><AnalogSimulator /><Sidebar /></>} exact />
