...
const CreateCourse = (props) => {
  ...
  const createCourse = () => {
    ...
    Axios.post("http://10.25.101.103:8000/api/course", courseObject, {
      header: {
  ...
  const joinCourse = () => {
    ...
    Axios.post("http://10.25.101.103:8000/api/checkCourse", codeObject, {
      header: {
        "Content-Type": "application/json; charset=utf-8",
      },
    })
      .then((res) => {
        if (res.data.success) {
          ...
          Axios.post("http://10.25.101.103:8000/api/records", recordObject, {
            header: {
              "Content-Type": "application/json; charset=utf-8",
            },
          })
