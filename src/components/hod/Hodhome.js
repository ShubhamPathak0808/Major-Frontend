...
const Hodhome = () => {
    ...
    React.useEffect(() => {
        ...
        Axios.get(`http://10.25.101.103:8000/api/fetchCourse/First%20Year`, {
            header: {
            "Content-Type": "application/json; charset=utf-8",
            },
        })
        ...
        Axios.get(`http://10.25.101.103:8000/api/fetchCourse/Third%20Year`, {
            header: {
            "Content-Type": "application/json; charset=utf-8",
            },
        })
        ...
        Axios.get(`http://10.25.101.103:8000/api/fetchCourse/Fourth%20Year`, {
            header: {
            "Content-Type": "application/json; charset=utf-8",
            },
        })
