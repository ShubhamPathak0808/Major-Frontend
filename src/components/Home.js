...
const MyCourses = () => {
  ...
  React.useEffect(() => {
    //user
    Axios.get(`http://10.25.100.77:8000/api/${userType}/${_id}`, {
      header: {
    ...
    //courses
    Axios.get(`http://10.25.100.77:8000/api/fetchCourse/${userType}/${_id}`, {
      header: {
        "Content-Type": "application/json; charset=utf-8",
      },
    })
  ...
  const getTeachers = () => {
    ...
    courses.map((course, index) => {
      Axios.get(`http://10.25.100.77:8000/api/teacher/${course.teacher_id}`, {
        header: {
          "Content-Type": "application/json; charset=utf-8",
        },
      })
  ...
  const getStudentCount = () => {
    ...
    courses.map((course, index) => {
      Axios.get(`http://10.25.100.77:8000/api/studentCount/${course._id}`, {
        header: {
          "Content-Type": "application/json; charset=utf-8",
        },
      })
