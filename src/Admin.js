...
const baseURL = "http://10.25.101.103:8000/";
...
class Admin extends React.Component {
  ...
  download(id){
    fetch(`http://10.25.101.103:8000/download/${id}`).then((error, res) => {
      this.getArticles();
    });
  }
  addBook() {
    ...
    if (
      ...
      axios.post("http://10.25.101.103:8000/addbook", materialData).then((res) => {
        ...
        // .then((res)=>{
          ...
          axios.post(
            `http://10.25.101.103:8000/addBook/attachment/${res.data._id}`,
            formData,
            {
              headers: {
                    ...
                    >
                      ...
                      <CardBody>
                        ...
                        <Button
                          ...
                          href={`http://10.25.101.103:8000/download/${id}`}
                          target="_blank"
