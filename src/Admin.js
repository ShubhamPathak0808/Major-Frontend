...
const baseURL = "http://10.25.100.77:8000/";
...
class Admin extends React.Component {
  ...
  addCopy(id) {
    fetch(`http://10.25.100.77:8000/addcopies/${id}`).then((error, res) => {
      this.getArticles();
    });
  }
  download(id){
    fetch(`http://10.25.100.77:8000/download/${id}`).then((error, res) => {
      this.getArticles();
    });
  }
  addBook() {
    ...
    if (
      ...
      axios.post("http://10.25.100.77:8000/addbook", materialData).then((res) => {
        ...
        // .then((res)=>{
          ...
          axios.post(
            `http://10.25.100.77:8000/addBook/attachment/${res.data._id}`,
            formData,
            {
              headers: {
  ...
  getTopIssued() {
    fetch("http://10.25.100.77:8000/topissued")
      .then((response) => response.json())
      .then((res) =>
                    ...
                    >
                      ...
                      <CardBody>
                        ...
                        <Button
                          ...
                          href={`http://10.25.100.77:8000/download/${id}`}
                          target="_blank"
